    ...
    <div className="flex gap-8 mt-20">
        ...
        <div className="flex gap-1">
          ...
          <div className="w-[842px] flex gap-10 h-[243px] border-l-2 border-b-2 border-[#3e3e3e] px-5">
            <img
              src={zigzagIcon}
              alt="Zig Zag "
              className="absolute top-[490px] left-[196px]"
            />
      ...
      <div className='h-[392px] w-[711px] flex-1 flex items-center justify-between p-14 bg-gradient-to-r from-[#0A66C2] to-[#5994CE] rounded-[10px]'>
        <div>
          ...
          <p className="mt-5 font-medium text-[22px] text-zinc-50">New Assessment&#39;s</p>
        </div>
        <div className='relative'>
          <img className="relative top-10 left-10" src={girlImage} alt="Office Girl" />
          <img className="relative w-[132px] h-[165px] bottom-52 right-10" src={girlImage}  alt="Office Girl" />
